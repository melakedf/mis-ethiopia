...
export function ProjectGallery(){
 ...
 return <section className="site-section bg-[#f6f6f6]" aria-label="Project photo gallery"><div className="site-wrap"><div className="mb-9 flex flex-wrap items-end justify-between gap-6"><div><p className="giving-kicker">Our work in pictures</p><h2 className="section-title">People. Participation. Possibility.</h2></div><p className="max-w-sm text-sm leading-6 text-slate-600">Preview gallery with temporary stock images. MIS project photographs will replace these images.</p></div>
